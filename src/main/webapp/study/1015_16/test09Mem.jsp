...
<head>
  ...
  <script>
  	...
  	if('<%=mid%>' == '') {
			...
			location.href = "<%=request.getContextPath()%>/study/1015_16/test09.jsp"
  	}
  </script>
</head>
<body>
...
<div class="container">
	...
	<hr/>
	<div><a href="javascript:logoutCheck('test09.jsp')" class="btn btn-success">로그아웃</a></div>
</div>
<p><br/></p>
</body>
</html>