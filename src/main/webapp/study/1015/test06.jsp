...
<p><br/></p>
<div class="container">
	<form name="myform" action="test06Ok.jsp" method="post">
	<fieldset>
		<legend>아이디와 비밀번호를 입력하세요</legend>
		<div>아이디
			<input type="text" name="mid" id="mid" value="hdk1234" class="form-control mb-2" required autofocus placeholder="아이디를 입력하세요" />
		</div>
		<div>비밀번호
